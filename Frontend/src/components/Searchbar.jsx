// SearchBar.jsx
// Plain React (JSX) search bar component.
// - Controlled or uncontrolled
// - Optional debounce
// - Suggestion list with keyboard navigation (ArrowUp/Down, Enter, Esc)
// - Clear button and optional search button
// - Minimal inline styles; adapt CSS classes as you like

import React, { useEffect, useRef, useState } from "react";

export default function SearchBar({
  value,                 // controlled value (string)
  defaultValue = "",     // uncontrolled start value
  onChange,              // (value) => void, called when input changes (debounced if debounceMs provided)
  onSearch,              // (value) => void, called on Enter or search button
  onSuggestSelect,       // (suggestion) => void, called when a suggestion is chosen
  placeholder = "Search...",
  debounceMs = 250,      // 0 or undefined => no debounce
